export const trainingData = [
  ...
  {
    input: 'As a tall person I can’t offer to reach something on a high shelf for a stranger, yet if they ask me I must oblige. This is the law of giants I guess',
    output: { grinzzly: 1 },
  },
  {
    input: 'Aliexpress is so useless: I tried to look up lighters and it gave me 49’427 matches',
    output: { grinzzly: 1 },
  },
  {
    input: '70 years old politicians making bad decisions on decades-year-plans about country development be like @mariyaGallina insisting she pick the movie even tho I know she is going to fall asleep in ten minutes',
    output: { grinzzly: 1 },
  },
  {
    input: 'Life is soup, I am fork',
    output: { grinzzly: 1 },
  },
  {
    input: 'Life is soup, I am fork',
  ...
  {
    input: 'So it’s Friday, huh? Don’t push to production tho',
    output: { grinzzly: 1 },
  },
  {
    input: 'Okay. Maybe saying Hi to my friend Jack wasn’t that much of a good idea on the plane in the mid-air',
    output: { grinzzly: 1 },
  },
  {
    input: 'No matter how kind you are. German children will always be Kinder',
    output: { grinzzly: 1 },
  },
  {
    input: 'Get sheet done!',
    output: { grinzzly: 1 },
  },
  {
    input: 'Tapes had side A and side B. So it’s only logical that their succesor is the CD',
    output: { grinzzly: 1 },
  },
];
